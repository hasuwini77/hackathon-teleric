...
export default function Page() {
  ...
  return (
    <main className={`relative min-h-screen w-full overflow-y-auto overflow-x-hidden cursor-none transition-colors duration-1000 ${theme === "dark" ? "bg-black" : "bg-white"} scrollbar-hide`}>
      {/* Custom Cursor */}
      <CustomCursor />
      ...
      {/* Immersive Overlay */}
      <div className={`fixed inset-0 pointer-events-none z-0 ${theme === "dark" ? "bg-gradient-to-b from-transparent via-transparent to-slate-950/40" : "bg-gradient-to-b from-transparent to-blue-50/20"}`} />
      ...
      {/* CSS Vignette */}
      <div className={`fixed inset-0 pointer-events-none z-20 shadow-[inset_0_0_200px_rgba(0,0,0,0.9)] ${theme === "dark" ? "opacity-40" : "opacity-10"}`} />
    </main>
  );
}
