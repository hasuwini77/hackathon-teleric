    ...
    <main className="h-full flex flex-col items-center justify-center p-6 bg-background text-foreground overflow-hidden">
      ...
      <div className="w-full max-w-2xl">
        ...
        <div className="flex flex-col items-center mb-12 animate-in fade-in slide-in-from-bottom-4 duration-700">
          <div className="w-16 h-16 rounded-2xl bg-primary/10 flex items-center justify-center mb-6 border border-primary/20 shadow-lg shadow-primary/5">
        ...
        <div className="relative min-h-[350px]">
          {step === "hero" && (
            <div className="space-y-8 animate-in fade-in slide-in-from-bottom-8 duration-700 delay-200">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div
                  ...
                  className={cn(
                    ...
                    cvUploaded ? "border-green-500/50 bg-green-500/5" : "border-border hover:border-primary/30 hover:bg-muted/50"
                  )}
                >
                  <div className={cn(
                    "w-12 h-12 rounded-full flex items-center justify-center mb-4 transition-colors",
                    cvUploaded ? "bg-green-500/20" : "bg-muted group-hover:bg-primary/20"
                  )}>
                    {cvUploaded ? <CheckCircle2 className="w-6 h-6 text-green-400" /> : <Upload className="w-6 h-6 text-primary" />}
                  </div>
                ...
                {/* LinkedIn Field */}
                <div className="p-8 rounded-2xl border border-border bg-muted/30 flex flex-col justify-center">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      className="pl-10 bg-background/40 border-border focus:border-primary/50 transition-all"
                      value={linkedinUrl}
              ...
              <div className="flex flex-col gap-4">
                <Button
                  size="lg"
                  className="w-full h-14 text-lg font-semibold bg-primary hover:bg-primary-hover shadow-xl shadow-primary/20"
                  onClick={nextStep}
                >
          ...
          {step.startsWith("question") && (
            <div className="bg-muted/30 border border-border rounded-3xl p-8 md:p-12 animate-in fade-in slide-in-from-right-8 duration-500">
              ...
              <div className="space-y-4 mb-10">
                <Input
                  ...
                  className="h-14 text-lg bg-background/20 border-border focus:border-primary/50"
          ...
          {step === "redirecting" && (
            <div className="flex flex-col items-center justify-center p-12 text-center animate-in fade-in zoom-in-95 duration-500">
              ...
              <Loader2 className="mt-8 w-6 h-6 text-primary animate-spin" />
            </div>
          )}
        </div>
        ...
        <div className="mt-12 text-center">
          ...
          <p className="text-[10px] uppercase tracking-widest text-muted-foreground/40 font-medium">MentorAI Personalization Engine v1.0</p>
        </div>
      </div>
    </main>
  );
